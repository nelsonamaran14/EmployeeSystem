...
export class EmployeeComponent {
  ...
  insertEmployee() {
    var employeedto: any = {};
    employeedto.firstName = this.empObject.firstName;
    employeedto.lastName = this.empObject.lastName;
    employeedto.contact = this.empObject.contact;
    employeedto.email = this.empObject.email;
    employeedto.dob = this.empObject.dob;
    employeedto.address = this.empObject.address;
  ...
  insertOrUpdateEmployee() {
    ...
    if (this.isRecordSelected) {
      ...
      var employeedto: any = {
        ...
        firstName: this.empObject.firstName,
        lastName: this.empObject.lastName,
