...
app.post('/insertEmployee', (req, res) => {
    ...
    console.log("Working")
    const sql = 'INSERT INTO employee (firstName, lastName, contact, email, dob, address) VALUES (?, ?, ?, ?, ?, ?);';
    const values = [
...
app.post('/signin', (req, res) => {
    ...
    const sql = 'SELECT id FROM EMPLOYEE where firstName=? and dob=?';
    const values = [
        loginUser.firstName,
        loginUser.dob
    ];
...
app.put('/updateEmployee/:id', (req, res) => {
    const id = req.params.id;
    const employeeData = req.body;
    const sql = 'Update employee set firstName=?, lastName=?, contact=?, email=?, address=? where id=?;';
    const values = [
        employeeData.firstName,
        employeeData.lastName,
        employeeData.contact,
